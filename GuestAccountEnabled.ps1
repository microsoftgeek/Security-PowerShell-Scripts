...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        $results = Search-AD -dnsDomain $domain -attributes "whenchanged", "useraccountcontrol" -baseDN $DN -scope "Subtree" `
        ...
        if ($results.Count -gt 0) {
            ...
            $thisOutput = new-object psobject -Property @{
                ...
                LastModified = [datetime]::ParseExact($results.Attributes.whenchanged[0],"yyyyMMddHHmmss.0Z",$null)
            }
    ...
    if ($failcount -gt 0) {
        ...
        $res.Remediation = "If the guest account is enabled, this could present a security risk. This account should be disabled at all times."
    }
    else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA3gPwVnEvqbT+U
# DfgVpeIgb0Ds1l1xcE6JeaNsk3NfY6CCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIMboEsqh8nCn9KigtJj+TGcQga3ouU0CaMCMLiHc
# IslAMA0GCSqGSIb3DQEBAQUABIIBACrs8o9jZK/IdhKM5O/BPHfbR+W+aBJVxTH1
# SZDZ8j81/NQgAjtoVJypqF+UB540YbEu3fbKFn31rtjEjgEpoTYvatUult3Dxetr
# lfjHRBsReL1KZCQF/Hv3yJ2aoRKTZI0DQ9NT1vVkTuAJHg7cXmwsZAA3OcWYZ/Ro
# L8m2/Ksl5+jz25QCRZEY6uos7cZElGUbzD/TBlEs9AYCzcehMGSWXemqM4VkG62E
# h7426SpywxoVWm27SZ70UTe5jjUVQc6XINvY5ur3DffOxvHPvWCti80ywXHhQu0l
# tEgHPHeemmv2PA8uHqe4WkTnLLQ9su1C0jHTXzvVV0E9Am3+BUmhggIwMIICLAYJ
...
# AQkEMSIEIMyG08gC1P+P0aHdiXpvSF8byslnPGtcv933Or8/RrkcMA0GCSqGSIb3
# DQEBAQUABIIBAINvlbn4AYS992l5mXj3IeoOY+T5YBe4NqODXvT48H9nXWrOJp+w
# RFB7m3BYGmvpMxANNAtDo6LtOWmJ/UX2vj3FPbVY7sS0mKoel2PIsv00C1hYwZ3f
# 9nxM7xeN26BupmPfYEgN5DfpjdCPdJQi31vkaauSWLz8eZAuSWwNkuqQ+8XXOcKq
# QoEp27A+ZdmLuXFubMVOVmeDKfhZODZMgW1zSsnQZ1/3XJ90ouur11tH/mq/jxyK
# exfJ0pCCe3EOOZnpMCUiTNKrLeQIVHt8//jmzHx3fmmHyARXnC+YKTX04GwAd6Gi
# nwInQoXv8ZwtxkQFExhEQ8hFLPZnUAZn1iU=
