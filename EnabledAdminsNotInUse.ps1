...
try {
    ...
    $whenCreatedThreshold = "{0:yyyMMddHHmmss}.Z" -f (Get-Date).AddDays(-$daysToRemove)
    foreach ($domain in $DomainNames) {
        ...
        $results = Search-AD -dnsDomain $domain -attributes "lastlogontimestamp", "samaccountname" -baseDN $DN -scope "Subtree" `
            -filter "(&(admincount=1)(samaccounttype=805306368)(!(userAccountControl:1.2.840.113556.1.4.803:=2))(lastlogontimestamp<=$lastLogonThreshold)(whencreated<=$whenCreatedThreshold))"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDeGNily1rPHOK6
# iMe6XQA+lb5UatZeZkVofkpqWdUlOKCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIOLX/oVOtimKjmsp8C9ifzNac6SOdUD+633/PTl1
# 0eA0MA0GCSqGSIb3DQEBAQUABIIBAF4wZGvPRnvFJTYGkBSr4h15nH6rBsR0FK40
# g0X0x7jR4MtOefOkncyw0cEfbXoW3O+qIMbTckV6g2xW4RYC6Ot3sd2giq3BD9GI
# c1Rw3GTe4AX/SRQszmQg+t/GKRappr1B6GU4zM5S9pI5mGL45OB5cqZ2YVs2EQ3V
# dAoo3p4Gdla7KpYa5VO8PNvLQjvLB3ZRtWPLVliJHiPokC+IINC22dV/cYzXqTyA
# hBZ1a2fc8iz89fMalLbN/wk4POrf+AozQonYG3VFeVZ3wVu5aRjCq2qD+UcFD+G6
# UzawDdTtgBxOrNOHare/Zf/pcrCxbiSBamBotYoaLpZm7V+pp/ihggIwMIICLAYJ
...
# AQkEMSIEIAfhAaaIUnwsjvTqV3X4hqaoulC3inNye+6kWmEh0CNtMA0GCSqGSIb3
# DQEBAQUABIIBAL39sr4v7amvTn5H+UzavrM8f2iGTGBhMcxG5O6RKlqwl+lmkp13
# wEcEfZxn2oBZI5DeBO+DK0A2a7b5A4rIG2OnQG7+NaFjegtVLvFSsoSpaplHNrKb
# 3eORRQVYXB7WAVbxaeFSlpNn3jkHN5Vn/3pd5MIXfM/hgYcml2htzJJW1699M+pM
# oI8VRs3K1Q+OmDQOKjXjTBp8trcyxU7pZpMs34IDufGrIAIJVnQwMK9Pjg8pwDB3
# 1frSRqU8iH82AffUznXRfTkOXXfuF4ap0jZgUIaqOJhotmBtLWVWNCXjNWjB5tIG
# MJ9RayyxkYHM1pdNZMZa7qoUl3UhEAa1w9g=
