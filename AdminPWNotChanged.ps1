...
try {
    ...
    if ($res.Score -ne 100){
        ...
        $res.Remediation = "Ensure that the built-in domain Administrator account password is changed at least twice per year."
        $res.Status = [Semperis.PSSecurityIndicatorResult.ScriptStatus]"Failed"
        $res.ResultMessage = "Found $($outputObjects.Count) domains whose administrator's password has not changed in the last $daysToRemove days."
    }
    else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCRGe4tUfIbfDSg
# 1zBWEVarIKDj/RHExzCTJJ833G5zoaCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIEsdishQSKHO7gSINsqNjU9dCWvMr8E5yySe7e19
# gKyIMA0GCSqGSIb3DQEBAQUABIIBAGkae/kvGZ9E21LeZJQyo7DcJy4SSWe87gcS
# 3YlNcN2eJJBUL589YDuVACFF5thSyrwlPfiA0H9pGJonR92AAk8Bv2LEyrN7oQcN
# pKmod93TbJgtxpYIcnwbEounIj2jdWHnMYKvkh+fTDJE9NUqcSzoFTgpNtzzSUA4
# eSEcCIw4y/Ys4flF0P11HrRd1ARpkJ2m3z7eF79IFtyr3P07vDXsVC6bH/129v5a
# XZSJpxQNW9ImMasQU0bQKwdvtmQu22cJ97tWA5oLibs247Rt04L/ffAnES3QfX4E
# 2dyJP3rmE3OQDZA7VeKq7QPng6xud96XEopBdyTDb2yEO669TUehggIwMIICLAYJ
...
# AQkEMSIEIBkh9I93I4b4QXWYOsq5xrdbIioBmGEse/EKghJCQFnPMA0GCSqGSIb3
# DQEBAQUABIIBAA3MvSNdGi0APGyyusPX30mWTJrP4Uq9v8UW6pH9quv2okUaDNXp
# iETyBX8vxZakLN11XIJdj5a2GsKUGbBbACU9BoIuw0PM76vZTyCUYfkcOLalSBx5
# ykTMxzrOQVYtulgEapN6d1KZrOlfsp00F5JCgA/4xG7vxz9FluriEd3kv8tNjsW4
# /xQATV3F8aSmk05LEUM2NRHQ5H0p/ScMwlX/kynno86h7OIPCmU8GcTWlbmWfGTK
# RFfQ+Pb+2YfNWG9ff3uIpcw94HAmpjfjo+eUrLrTLdjP5mmyzg06QE9EPsgNhptK
# +Kb3+agvr+vZvlaxAraANIM6NlU1Uj+to7o=
