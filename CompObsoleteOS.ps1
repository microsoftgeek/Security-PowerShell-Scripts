...
try {
    ...
    $daysToRemove = 30
    $activeThreshold = (get-date).AddDays(-$daysToRemove).ToFileTimeUtc()
    foreach ($domain in $DomainNames) {
        ...
        # Get a list of all computers with obsolete OS (operatingSystemVersion value 5 and 6 should cover OS versions 2000 - 2012R2, excluding 6.3 - 2012R2)
        $results = Search-AD -dnsdomain $domain -attributes $attributes -baseDN $DN -scope "subtree" `
            -filter "(&(objectCategory=Computer)(|(operatingsystemversion=5*)(operatingsystemversion=6*))(!(operatingsystemversion=6.3*)))"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAHcIwx4DeszNOi
# C61/DCGjoKFFQz9sFgyb6k+2fEr2CKCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIMiOCs25Sh1f+KHovrq1AfSs4ejizuNm1/Bt5tUP
# 7r7FMA0GCSqGSIb3DQEBAQUABIIBAFJL052t8UNRaP0VeZPtlApGKgo9QA2VLii6
# htuOCCwP/PzX9y6EHDQN5bDk/QvDapqmacn8g2LV7Yqk6gl3QPFSNayLYHgPQ9kR
# aYgDLwvsCe43nmNdPTvgGpyi1hbfM/ya8NyVdOAkkVMSUjBjNtkzSG2rN03KFldX
# chX70HAXIAjHj8okFKq2W+NdaNVKCNrhfVwrrd9PUwTwCq3X/DqfgMWQkEMMcrjh
# XjBOXm7VfD6tvojDQRYUsX0+9/XFSazLl75aKOgLWlVdrhqLRPpIU3y+5GL1vfT7
# LAAN+usR9+IJRGKHw8asA3k6JA7iZPwrl8Jvg2x5uwUtgSo8ps2hggIwMIICLAYJ
...
# AQkEMSIEIH8Om2T94rshAX9X/Vv6Wcp3mHnqqL+DBo63IHzr4CCwMA0GCSqGSIb3
# DQEBAQUABIIBAClwR18LquL+Vwz5p07NKbom62tZW6JScQN+oOWcSi2d0WBJSz7z
# Rq1WyMmJWvDco+rCtOrz7GR5YpgJsoiMHMx+Rgu1xvESR4Bo6Xa30f3qhCPrwvwh
# W2m24uZPk208EVyg+6FImOv91LZEwpenYZq90COs/7olSV/1Zm9Tv3wA/DKCBHc+
# KbFAbBARnsnb8fI+EpccUmcKhiVcU8A2Pe3k6B1679v2C4ZsO6vs8+Tq43EZqQcg
# rt+2OJ7ROGTD3s9TwvrTgvjx4E60edw+jhzG0eKSxeJOUrF//nNMGx+6KDdKYc5e
# isB/d1swZI7EgaHJ0RTKkOUKkALU9YIubd4=
