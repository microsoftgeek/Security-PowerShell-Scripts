...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        $results = Search-AD -dnsDomain $domain -attributes "msds-allowedtoactonbehalfofotheridentity" -baseDN $DN `
            -scope "subtree" -filter "(&(msds-allowedtoactonbehalfofotheridentity=*)(!(primarygroupid=516)))"
    ...
    if ($failedDomainCount -gt 0){
        ...
        $res.Remediation = "Validate that every delegation configured is known and necessary."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6v3BpHkGxNh9e
# PtFIeOSsdvWF77hEXoD75LArXLz42qCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIOwT0E5fI/3Q0uQcJcZp+pIJKuRWXgh7U6PQ+6PD
# 8PYdMA0GCSqGSIb3DQEBAQUABIIBAISSPgqjfg+qQTjyfSP70MvsDVNM/9l1h6jS
# 4vBwxob7VdGabVzltjXrOs0HfCppewHUUfPpoYzxG6PwjvIhSBsBxIthE6bIodax
# lyN6YMHJjXBjRWn1CrFntcXba56snyoM+dpxSiBXwUazylmUEB3/WV09eH3BFl5F
# vN0qXZFKgqwkckd2jFmR8vVSF0aRaSQR4slCPclPdP1PzFASNxUH5xT9Y8tLLioW
# xFozpOGAKH4zgllL9A1hBJ4ldrgRj/sIFKn3KsdbPqfCUojP07yZrtQWmZBmLmbi
# elG7eEnZIfi+aIGj44WZQukT0mkv7I0NreIVkdcdohcfLcC8fMShggIwMIICLAYJ
...
# AQkEMSIEIN3SaPHliLrA++CgqT8INa/oF1tTgL8I5zr6KjoF06qQMA0GCSqGSIb3
# DQEBAQUABIIBALEl7rlxNi89tbwbM91QW18mO0jwghyLmQQrzli66rSDfgruW3AW
# GbXXrCkREV5l56C92kQ8Izb5GZRKVcP+REkJY1+LM0vEUaB7TDjZGMvLwMPpyq9j
# oWfHV4LSUAm29/xqAFffAYdgIgBoMA/amxgJjbOkJNKdpBOIzyV9Llbm/9/QPKm8
# mlPCU5JmfkW+QLzh/J7yQWhfDwu76Vpk+Xe1UjeUxKLlo1hENoNoBSupUw5NnLS1
# IV3mUsGql3rsFEcerZaZQoLMo1wsR7XebmgpqoXtPSWy7dtZYNLO3+jYJbiqGrx4
# A9D+WGluiL6H3As0pxS3Hrv3EbAtmw4do18=
