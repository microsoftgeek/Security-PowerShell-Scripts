...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        $results = Search-AD -dnsDomain $domain -attributes "msds-allowedtoactonbehalfofotheridentity" -baseDN $DN `
            -scope "subtree" -filter "(&(msds-allowedtoactonbehalfofotheridentity=*)(primarygroupid=516)(samaccounttype=805306369))"
    ...
    if ($failedDomainCount -gt 0){
        ...
        $res.ResultMessage = "Found $($outputObjects.Count) Domain Contoller objects with Resource Based Constrained Delegation configured."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA7/p5AsbJN1XiA
# sTXORqbqB3ZLQo4vpTZQCW7NHGKI2KCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIGkp5/XET/9O1wxu00QW8o4kPBnZwbZ++54EvWjq
# cvgmMA0GCSqGSIb3DQEBAQUABIIBAB+lIUYb5/bx4A7ZDQasInWVCImF1j2rtvjV
# S5SOD3NJoD+iWaKvqCauug2TGMoitdsV53pmz39oUiI4OuHsT8hZzpe0+IpSuG9Q
# KptuLBqaH/u/1y4Ns60v9QgnIEJrLD4FtYT1sIKnwgP/Pho7SAGY5lHw6X8geEHx
# 51U5rkW/Soz6n4hdXWtgFeVep6RgqpEHO2YAoW1ysVaVxyqOesLksxCXGoacEK1d
# hNT+wiIiRPYwPs3Kn0NxNkWM0NrEuMBsRzVzZ9yEMr5qA2gZYdOYQkt6RbnFx4OT
# yMG9UdbSTVB1LBzzlkfWQOJ1kyX9TnpIzVoYo9mnZDYociPdheWhggIwMIICLAYJ
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIxMDMxNzE5MzM0OVowLwYJKoZIhvcN
# AQkEMSIEIHHBJl4QDLGBSJia9e6ovFI8qykuzsMkrmYHFMs2fciyMA0GCSqGSIb3
# DQEBAQUABIIBAIy503Gfu7vlsYZqzubbqUDV44WiDUPoOhziImL2ix+H3+6T7Pow
# MQ7V2pCepp5mwTQadfmObJygcw+dXYSh51KRGM2Pjcwo6CjcSWBb7It40bazF+Qj
# odV+p3z9qIy8FwoepIdgwmQnLJRAK7CaByDVxXqgyp7GDwtl7dKqTan47Wf4t6gS
# ID4zW56EiwRrsN4tImqHldqixyPzWgIY+HRtK16oYS3hIKnxCuEBaTHWirASMr/q
# Hp39yZaOdspKscK2M2whcHmYt4V7nvFpuEvqz+5K5eWw93iHYfMP1TviIQGR1V5A
# rb/LXOzUNENf1VBbITmvc+VlIZ1Acc0YKvs=
