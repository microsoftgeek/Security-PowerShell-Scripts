...
try {
    ...
    $result = Search-AD -dnsDomain $ForestName -attributes "whenchanged", "dsheuristics" -baseDN "CN=Configuration,$DN" -scope "Subtree" `
    ...
    if ($result.Count -gt 0) {
        ...
        if ($flag.Count -ge 16 -and $flag[15] -ne "0") {
            ...
            if ("0123456789abcdef" -match $flag[15]){
                ...
                foreach ($key in $operatorgroups.keys){
                    if ($operatorflag -band $key){
                        $grouplist.Add($operatorgroups[$key]) | out-null
                    }
                }
            }
            else {
                $grouplist.Add("Invalid value") | out-null
            }
            $scoreObjects += 0
            $failcount++
            $thisOutput = new-object psobject -Property @{
                ...
                LastModified = $result.Attributes."whenchanged"[0]
            }
    ...
    if ($failcount -gt 0) {
        ...
        $res.Remediation = "Set dwAdminSDExMask flag (16th byte) on dsHeuristics to 0 or SDProp (AdminSDHolder) behavior will not fully apply to Operator groups. For more information see <a href=`"https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-adts/e5899be4-862e-496f-9a38-33950617d2c5`">6.1.1.2.4.1.2 dSHeuristics</a> "
    }
    else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXwooxu2UOHAvQ
# 3WjDQUV3Wku/x/+cBs6LNPzFs+Q93aCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIEsR2XWssCnAqEIZQRqh1Mm780/Hv/AAoLrXNCQw
# rsCvMA0GCSqGSIb3DQEBAQUABIIBAKQmfUvDdqdfVIyTe/lmbkjXSi3r7mw7bwRm
# ERPtPOQeXj6p5w9BCTAs8mTO+5MbU9YXLu3SR2wyCbxRNi8S9l7hzZIvWgzPYUVn
# DZzQW9JC5jd+GLgNwSHZ5iIm44X/pli2drAOaGpN/7qh9yqz8s7aNU2i1CbEkvtK
# Ag++SLPmaOQWpAvZSgTy/esC7KSNq/F2y64l8Soz+ewLCY9rWuErrz7Nvv8BgALH
# cZLg9Pd4efMQAYM8mlxVEL9p9kqDE8YlTIIRZfwqWNWxlbgna6mZK7/mfZ+s7H/I
# AB6wrfuu+DdN5IXUfKtq74fQk0STyOgunjhOgvd0Bwt8iUtREDuhggIwMIICLAYJ
...
# AQkEMSIEICi02pU/h9NRU3iMWoKFiATo0H17OjY0RdGP+uM6cYsuMA0GCSqGSIb3
# DQEBAQUABIIBAJZRpqGP/hqfAWEkmW2D1NI6wJHRZ5kjWB7hV0iZCVD16r6Elgv8
# RBvrYmuREIVuHN1XYi3pljUAfXMk27VChU1TLNAmenmyl8FoODrYR5Peb2MN9Gen
# XKNv2ysqXqp8gK8/f2koODc0CRouVbKzo6htil8TZZGl/pgZYUBUXB+UBIxsnCmO
# Doiu6Mclkh+1C514+8wgw54XBby++JJdpHGZXADFHtZzXfwpSTk4R1Cvcf5J/D+Q
# vBVWy7Y1mqdcWWn5oQfHI35LB/OhrbKesjQX8ssaofwPXGybQ065yYsQK1IS8J4a
# 5eXFnlthhO3ppO4v+A77+nYbhPL01GQa5tA=
