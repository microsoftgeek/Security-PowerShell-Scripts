...
try {
    ...
    foreach ($domain in $DomainNames) {
        ...
        $results = Search-AD -dnsDomain $domain -attributes "serviceprincipalname" -baseDN $DN -scope "Subtree" `
        ...
        if ($results.Count) {
            ...
            foreach($result in $results) {
                $SPNs = @()
                foreach ($SPN in $result.Attributes."serviceprincipalname".GetValues("string")) {
                    $SPNs += $SPN
                }
    ...
    if ($failedDomainCount -gt 0){
        ...
        $res.Remediation = "Remove SPN from privileged accounts."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA5orzmfLFcZ07I
# 8K4GdsfhA5hpiFkqcTYxISf/FYn9AaCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIFDSwt9GLqc7hDmoKSihqLGwSYtqEk0Ue49d6+q9
# JI6aMA0GCSqGSIb3DQEBAQUABIIBAAlE53kchJ/4ugVdEAY2CewfVBTNWjTI1Pwo
# kMnvFhh/wGB91dU4YExTxFDc+/wxNm/HUx8hknL/WsmQFk1cnZjypNTUB63B44Pb
# qgNpBNP/6Wc/43APSygeiH2rY6nxvCfQn8pTI6kY773fNedWGDLNYmn7pcil6+vC
# aV2Mmf7dy3UfYUWDJuX9JvIbZYru+i/ZylkkpaB2rmom5dkk/96FFW7sFiye5DIT
# zFy8WR95YU43XB2j9LUSk1VL5gg2bptWrhqcnQq2kkH8idptOrh5kYXqPDh4fvOl
# mcfA0jk0gF7j05Cj9IpBz0hASnfl/UJXWljyt3B/QiBt0vpsIcyhggIwMIICLAYJ
...
# AQkEMSIEIGVvb+KiqkTkunhYpHTYXXlI+JPZmB3+COgMahIid9EKMA0GCSqGSIb3
# DQEBAQUABIIBAAaOwKKjEoDd+qFHkhPFitF8ykLBPgkBHe/s6Qw80zEuA59YZpQ5
# E/bRpqCcDjcU1RqTdJu1R+58MS1yL4yGvq50wftwJ1Yt6GaZ8q1CXaFSk3Iwnn+Y
# yaaP/ubtjcYuInXPqARBAX/7OMpT9iAWcYQTi38nBhLg3X4sYZOIHe9Aq0zdPqPu
# RCJ5s/i3niYSFlk/gu+nUWle31X2h1Mlnc9g0G4JwVE0zsfXJ7ogaQMJkUVGvcsN
# vWxNJPfFWBVoks46MnMr6jAAdKMyjoGz+c3wvUYA0Exb/dIo4pfKq4CWOGIsysWr
# Li7MuznSA9WrzUX7OHWFxxrrsUjdQed6XIA=
