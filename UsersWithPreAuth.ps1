...
try {
    ...
    if ($failedDomainCount -gt 0){
        ...
        $res.ResultMessage = "Found $($outputObjects.Count) users with pre authentication enabled."
        $res.Score = 100 - (($failedDomainCount / $DomainNames.Count) * 100)
        $res.Remediation = "Ensure that pre-authentication is enabled on all users if possible; if not possible, consider reducing their privileges instead."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDoqN+J3KnuBkWq
# KbVhSlHTe4abfpxMdvKj1ZUZQtv4uKCCE+UwggSUMIIDfKADAgECAg5IG2oHJtLo
...
# ARUwLwYJKoZIhvcNAQkEMSIEIIp8ESoiQrWopVWNl9RncRc3m2L8iEid3N0wdMrg
# VOz+MA0GCSqGSIb3DQEBAQUABIIBADDpqgagkGGG8UYzY8M1bRUkTYzhUzmDWcII
# pl+D7F35EgeeL89N7ovjIpLXr0o+PMkruOcXMWPFYrl++A+dQ1Xg9Rnkyy1FtyZ3
# 1kHRtDq/i4UMG7IID6wIjB/5UUrxuvF+zwOwhJXJ0ILVxBY3R4aqrOpYbDpKNenG
# 7TpVXIve3+bE5MXvqP3c8fS6n9Cd4ftHgkvxcswKsXR+dP+ufBndaoOghHmGSwvR
# B/xnTJ0eDx+4+rxBV/vGM4H952QO9sLdQhghBa3nzwcv1aJSGop7bVzbsF4ArzI0
# b4DyFlXrr8268AcVypwn4TzSEDKLNhTUphkZXrzzimEXN9N+ExOhggIwMIICLAYJ
...
# AQkEMSIEIEyf2HRacQF7qpJyECiliR5jX+Y5CNkspBMKmDzqIgkgMA0GCSqGSIb3
# DQEBAQUABIIBAFA6k4yJLdP+Kcap1wCtP7ue6hIMOqxuF0DvRJ80iVAwlEdo1SZC
# hIqpLpsvo5XMt64MsNoJCgpoFPEEk1FcqeI12EFqfMv4JZHf1PYnJQ7oE8/6Qxg7
# xUdk1hTuww69DJdpDwFq3zGOdMOlx2DaS7CQth+gd0imgf65odE0xyzHpU9l/yzu
# PdO3qTDIX/DSaWDDeip0i175VpHEybqaODi9pdUlwngTd1m1yIdI6imF42GkKnlY
# dPWoHdMd8lvqLiA1r8S5amdAzFzcKu2uDLGlu7IqIw5G7cpSpwZ4JXzIqnEEjYH6
# sKeIGsYBukUnQd+5C/Vx8N5EsE56aRkMRjI=
